...
//motor_clean
#define MOTOR_CLEAN_F_PIN         GPIO_Pin_4
#define MOTOR_CLEAN_F_GPIO        GPIOE
#define MOTOR_CLEAN_F_SET         GPIO_SetBits(MOTOR_CLEAN_F_GPIO  , MOTOR_CLEAN_F_PIN)
#define MOTOR_CLEAN_F_RESET       GPIO_ResetBits(MOTOR_CLEAN_F_GPIO  , MOTOR_CLEAN_F_PIN)

#define MOTOR_CLEAN_B_PIN         GPIO_Pin_0
#define MOTOR_CLEAN_B_GPIO        GPIOE
#define MOTOR_CLEAN_B_SET         GPIO_SetBits(MOTOR_CLEAN_B_GPIO , MOTOR_CLEAN_B_PIN)
#define MOTOR_CLEAN_B_RESET       GPIO_ResetBits(MOTOR_CLEAN_B_GPIO , MOTOR_CLEAN_B_PIN)
...
//MOTOR_CLEAN
#define MOTOR_CLEAN_F     MOTOR_CLEAN_F_SET;  MOTOR_CLEAN_B_RESET
#define MOTOR_CLEAN_B    MOTOR_CLEAN_F_RSET;  MOTOR_CLEAN_B_SET
#define MOTOR_CLEAN_STOP   MOTOR_CLEAN_F_RESET;MOTOR_CLEAN_B_RESET

//#define SPEED_DUTY 40//默认占空比 按1ms最小分辨率 周期50ms计算

//#define SPEED_DUTY_CLEAN 40//默认占空比 按1ms最小分辨率 周期50ms计算

//指令定义
#define COMM_STOP  'I' //停止    49
#define COMM_UP    'A' //前进    41
#define COMM_DOWN  'B' //后退    42
#define COMM_LEFT  0x43 //左转    43
#define COMM_RIGHT 'D' //右转   44


#define COMM_AUTO  '1'  //自动    31
#define COMM_ESC   '2'  //退出    32

#define COMM_7     '7' //清扫中档37 
#define COMM_8     '8'  //清扫中档38
#define COMM_9     '9'  //清扫高档39
