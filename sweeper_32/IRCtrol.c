   ...
   { 
     return; }
		 ...
		 switch(IRCOM[2])
		 {
			 ...
			 case 0x40: ctrl_comm = COMM_STOP;b=0; break;   
			 
			 case 0x0C: ctrl_comm = COMM_AUTO;b=1;break;
			 case 0x16: ctrl_comm = COMM_ESC;b=0;  break;
			 
			 
			 case 0x42: ctrl_comm = COMM_7;break;
			 case 0x52: ctrl_comm = COMM_8;break;
			 case 0x4A: ctrl_comm = COMM_9;break;
